...
$sqlForm = 'SELECT *
		FROM customer C';
$resultForm = mysqli_query($db,$sqlForm);
...
<div class="container">
<h1>&nbsp Customer Information</h1><br>
<div class="col-sm-8">
...
<div class="col-sm-4">
<h3>Customer Transactions</h3><br>
<form action="customerStat.php" method="post" class="form-inline">
