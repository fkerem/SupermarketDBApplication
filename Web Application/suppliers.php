...
<div class="container">
<h1>&nbsp Supplier Information</h1><br>
<div class="col-sm-6">
...
<div class="col-sm-6">
<h3>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Add Supplier</h3>
<form action="" method="post" class="form-inline">
	<label>Supplier Name</label>
	<input class="form-control" type="text" name="newSupp">

	<input type="submit" class="btn btn-success align-center" name="submit" value="Submit">
</form>
<?php
    ...
    $sql="INSERT INTO suppliers VALUES ('$sname')";
    ...
    else
    {
        ...
        echo 'alert("Successfully Registered"); location.href="suppliers.php"';
        echo '</script>';
    }  
